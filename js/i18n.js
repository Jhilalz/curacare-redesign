...
const I18N = {
  de: {
    ...
    "about.p1": "CultureMed ist Ihr ambulanter Pflegedienst in Alsdorf. Wir unterstützen Menschen dabei, in ihrer vertrauten Umgebung zu bleiben — selbstbestimmt, würdevoll und sicher.",
  ...
  en: {
    ...
    "about.p1": "CultureMed is your outpatient care service in Alsdorf. We help people stay in their familiar surroundings — self-determined, dignified and safe.",
  ...
  ar: {
    ...
    "about.p1": "كالتشر ميد هي خدمة الرعاية المنزلية الخاصة بك في ألسدورف. نساعد الناس على البقاء في محيطهم المألوف — باستقلالية وكرامة وأمان.",
  ...
  tr: {
    ...
    "about.p1": "CultureMed, Alsdorf'taki evde bakım hizmetinizdir. İnsanların alışık oldukları ortamda kalmalarına yardımcı oluyoruz — bağımsız, onurlu ve güvenli bir şekilde.",
  ...
  fr: {
    ...
    "about.p1": "CultureMed est votre service de soins à domicile à Alsdorf. Nous aidons les personnes à rester dans leur environnement familier — de façon autonome, digne et sûre.",
  ...
  ru: {
    ...
    "about.p1": "CultureMed — ваша служба амбулаторного ухода в Альсдорфе. Мы помогаем людям оставаться в привычной обстановке — самостоятельно, достойно и безопасно.",
