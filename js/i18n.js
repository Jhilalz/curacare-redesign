...
const I18N = {
  de: {
    "meta.title": "CultureMed — Ambulanter Pflegedienst in Alsdorf",
    ...
    "hero.kicker": "Ambulanter Pflegedienst · Alsdorf",
    ...
    "hero.card2.t": "1 Standort", "hero.card2.d": "Alsdorf",
    ...
    "about.p1": "Wir sind ein ambulanter Pflegedienst mit fachlicher Kompetenz, persönlicher Nähe sowie kulturellem und religiösem Verständnis.",
    "about.p2": "Unser mehrsprachiges Team bietet individuelle, zuverlässige und professionelle Pflege. Vertrauen, Qualität und eine persönliche Betreuung stehen für uns im Mittelpunkt.",
    "about.stat1.n": "24/7", "about.stat1.l": "Erreichbarkeit",
    "about.stat2.n": "1", "about.stat2.l": "Standort",
    "about.stat3.n": "100%", "about.stat3.l": "Engagement",
    "leitbild.kicker": "Leitbild",
    "leitbild.title": "Wofür wir stehen.",
    "leitbild.quote": "„Der Mensch steht im Mittelpunkt. Mit Respekt und Empathie begleiten wir Menschen im Alltag.“",
    "leitbild.author": "Das CultureMed Team",
    "leitbild.p1": "Wir bieten kultursensible, religionssensible und mehrsprachige Pflege, die individuelle Wünsche, Bedürfnisse und persönliche Glaubensüberzeugungen berücksichtigt.",
    "leitbild.p2": "Unser Ziel ist es, Selbstständigkeit zu fördern und ein selbstbestimmtes Leben zu Hause zu unterstützen.",
    ...
    "contact.locations": "Unser Standort",
    "loc.tag1": "Hauptsitz", "loc.tag2": "Zweigstelle",
    "loc.directions": "Route planen", "loc.phone": "Telefon", "loc.mobile": "Mobil", "loc.fax": "Fax", "loc.ik": "IK-Nummer",
    "footer.tagline": "Rundum. Bestens. Versorgt.",
    "footer.desc": "Ihr ambulanter Pflegedienst in Alsdorf, der neue Wege geht.",
  ...
  en: {
    "meta.title": "CultureMed — Outpatient Care Service in Alsdorf",
    ...
    "hero.kicker": "Outpatient Care Service · Alsdorf",
    ...
    "hero.card2.t": "1 location", "hero.card2.d": "Alsdorf",
    ...
    "about.p1": "We are an outpatient care service with professional expertise, personal closeness and cultural and religious understanding.",
    "about.p2": "Our multilingual team provides individual, reliable and professional care. Trust, quality and personal support are at the heart of everything we do.",
    "about.stat1.n": "24/7", "about.stat1.l": "Availability",
    "about.stat2.n": "1", "about.stat2.l": "Location",
    "about.stat3.n": "100%", "about.stat3.l": "Commitment",
    "leitbild.kicker": "Our mission",
    "leitbild.title": "What we stand for.",
    "leitbild.quote": "The person is at the centre. With respect and empathy we accompany people in everyday life.",
    "leitbild.author": "The CultureMed Team",
    "leitbild.p1": "We offer culturally sensitive, religiously sensitive and multilingual care that respects individual wishes, needs and personal beliefs.",
    "leitbild.p2": "Our goal is to promote independence and support a self-determined life at home.",
    ...
    "contact.locations": "Our location",
    "loc.tag1": "Headquarters", "loc.tag2": "Branch office",
    "loc.directions": "Get directions", "loc.phone": "Phone", "loc.mobile": "Mobile", "loc.fax": "Fax", "loc.ik": "IK number",
    "footer.tagline": "Wholly. Truly. Cared for.",
    "footer.desc": "Your outpatient care service in Alsdorf, taking new paths.",
  ...
  ar: {
    "meta.title": "كالتشر ميد — خدمة رعاية منزلية في ألسدورف",
    ...
    "hero.kicker": "خدمة رعاية منزلية · ألسدورف",
    ...
    "hero.card2.t": "موقع واحد", "hero.card2.d": "ألسدورف",
    ...
    "about.p1": "نحن خدمة رعاية منزلية بكفاءة مهنية وقرب شخصي وفهم ثقافي وديني.",
    "about.p2": "يقدم فريقنا متعدد اللغات رعاية فردية وموثوقة ومهنية. الثقة والجودة والرعاية الشخصية في صميم عملنا.",
    "about.stat1.n": "٢٤/٧", "about.stat1.l": "التوفّر",
    "about.stat2.n": "١", "about.stat2.l": "موقع",
    "about.stat3.n": "١٠٠٪", "about.stat3.l": "التزام",
    "leitbild.kicker": "رؤيتنا",
    "leitbild.title": "ما نؤمن به.",
    "leitbild.quote": "«الإنسان في المركز. بالاحترام والتعاطف نرافق الناس في حياتهم اليومية.»",
    "leitbild.author": "فريق كالتشر ميد",
    "leitbild.p1": "نقدم رعاية حساسة ثقافياً ودينياً ومتعددة اللغات، تراعي الرغبات الفردية والاحتياجات والمعتقدات الشخصية.",
    "leitbild.p2": "هدفنا هو تعزيز الاستقلالية ودعم حياة مستقلة في المنزل.",
    ...
    "contact.locations": "موقعنا",
    "loc.tag1": "المقر الرئيسي", "loc.tag2": "فرع",
    "loc.directions": "احصل على الاتجاهات", "loc.phone": "الهاتف", "loc.mobile": "الجوال", "loc.fax": "الفاكس", "loc.ik": "رقم IK",
    "footer.tagline": "رعاية شاملة ومتميّزة.",
    "footer.desc": "خدمة الرعاية المنزلية الخاصة بك في ألسدورف، تسلك طرقاً جديدة.",
  ...
  tr: {
    "meta.title": "CultureMed — Alsdorf'ta Evde Bakım Hizmeti",
    ...
    "hero.kicker": "Evde Bakım Hizmeti · Alsdorf",
    ...
    "hero.card2.t": "1 lokasyon", "hero.card2.d": "Alsdorf",
    ...
    "about.p1": "Mesleki yetkinlik, kişisel yakınlık ve kültürel ile dini anlayışa sahip bir evde bakım hizmetiyiz.",
    "about.p2": "Çok dilli ekibimiz bireysel, güvenilir ve profesyonel bakım sunar. Güven, kalite ve kişisel ilgi bizim için her şeyden önemlidir.",
    "about.stat1.n": "7/24", "about.stat1.l": "Ulaşılabilirlik",
    "about.stat2.n": "1", "about.stat2.l": "Lokasyon",
    "about.stat3.n": "%100", "about.stat3.l": "Bağlılık",
    "leitbild.kicker": "Misyonumuz",
    "leitbild.title": "Neyi savunuyoruz.",
    "leitbild.quote": "“İnsan merkezde yer alır. Saygı ve empatiyle insanlara günlük yaşamlarında eşlik ediyoruz.”",
    "leitbild.author": "CultureMed Ekibi",
    "leitbild.p1": "Bireysel istekleri, ihtiyaçları ve kişisel inanç değerlerini dikkate alan kültüre ve dine duyarlı, çok dilli bakım sunuyoruz.",
    "leitbild.p2": "Amacımız, bağımsızlığı desteklemek ve evde öz belirlenimli bir yaşamı güçlendirmektir.",
    ...
    "contact.locations": "Lokasyonumuz",
    "loc.tag1": "Merkez", "loc.tag2": "Şube",
    "loc.directions": "Yol tarifi al", "loc.phone": "Telefon", "loc.mobile": "Cep", "loc.fax": "Faks", "loc.ik": "IK numarası",
    "footer.tagline": "Bütünüyle. En iyi. Bakım.",
    "footer.desc": "Alsdorf'taki evde bakım hizmetiniz, yeni yollar açıyor.",
  ...
  fr: {
    "meta.title": "CultureMed — Service de soins à domicile à Alsdorf",
    ...
    "hero.kicker": "Service de soins à domicile · Alsdorf",
    ...
    "hero.card2.t": "1 site", "hero.card2.d": "Alsdorf",
    ...
    "about.p1": "Nous sommes un service de soins ambulatoires alliant compétence professionnelle, proximité personnelle et compréhension culturelle et religieuse.",
    "about.p2": "Notre équipe multilingue offre des soins individuels, fiables et professionnels. La confiance, la qualité et un accompagnement personnel sont au cœur de notre démarche.",
    "about.stat1.n": "24/7", "about.stat1.l": "Disponibilité",
    "about.stat2.n": "1", "about.stat2.l": "Site",
    "about.stat3.n": "100%", "about.stat3.l": "Engagement",
    "leitbild.kicker": "Notre vision",
    "leitbild.title": "Ce que nous défendons.",
    "leitbild.quote": "« La personne est au cœur. Avec respect et empathie, nous accompagnons les gens dans leur vie quotidienne. »",
    "leitbild.author": "L'équipe CultureMed",
    "leitbild.p1": "Nous proposons des soins culturellement sensibles, religieusement sensibles et multilingues, qui tiennent compte des souhaits individuels, des besoins et des convictions personnelles.",
    "leitbild.p2": "Notre objectif est de favoriser l'autonomie et de soutenir une vie autodéterminée à domicile.",
    ...
    "contact.locations": "Notre site",
    "loc.tag1": "Siège", "loc.tag2": "Agence",
    "loc.directions": "Itinéraire", "loc.phone": "Téléphone", "loc.mobile": "Mobile", "loc.fax": "Fax", "loc.ik": "Numéro IK",
    "footer.tagline": "Pleinement. Vraiment. Pris en soin.",
    "footer.desc": "Votre service de soins à domicile à Alsdorf, qui ouvre de nouvelles voies.",
  ...
  ru: {
    "meta.title": "CultureMed — Служба амбулаторного ухода в Альсдорфе",
    ...
    "hero.kicker": "Служба амбулаторного ухода · Альсдорф",
    ...
    "hero.card2.t": "1 филиал", "hero.card2.d": "Альсдорф",
    ...
    "about.p1": "Мы — служба амбулаторного ухода, сочетающая профессиональную компетентность, личную близость, а также культурное и религиозное понимание.",
    "about.p2": "Наша многоязычная команда предоставляет индивидуальный, надёжный и профессиональный уход. Доверие, качество и личное сопровождение — в центре всего, что мы делаем.",
    "about.stat1.n": "24/7", "about.stat1.l": "Доступность",
    "about.stat2.n": "1", "about.stat2.l": "Филиал",
    "about.stat3.n": "100%", "about.stat3.l": "Преданность делу",
    "leitbild.kicker": "Наша миссия",
    "leitbild.title": "За что мы выступаем.",
    "leitbild.quote": "«Человек в центре. С уважением и эмпатией мы сопровождаем людей в повседневной жизни.»",
    "leitbild.author": "Команда CultureMed",
    "leitbild.p1": "Мы предлагаем культурочувствительный, религиочувствительный и многоязычный уход, учитывающий индивидуальные пожелания, потребности и личные убеждения.",
    "leitbild.p2": "Наша цель — поощрять самостоятельность и поддерживать самоопределённую жизнь дома.",
    ...
    "contact.locations": "Наш филиал",
    "loc.tag1": "Головной офис", "loc.tag2": "Филиал",
    "loc.directions": "Построить маршрут", "loc.phone": "Телефон", "loc.mobile": "Моб.", "loc.fax": "Факс", "loc.ik": "Номер IK",
    "footer.tagline": "Полная. Лучшая. Забота.",
    "footer.desc": "Ваша служба амбулаторного ухода в Альсдорфе, идущая новыми путями.",
...
const NEWS_DATA = {
  de: [
    { date: "Juni 2026", tag: "Team", title: "Wir suchen Verstärkung", text: "Examinierte Pflegefachkräfte (m/w/d) für Alsdorf gesucht — werden Sie Teil unseres Teams." },
    ...
    { date: "April 2026", tag: "Standort", title: "Standort Alsdorf erweitert", text: "Mehr Kapazitäten für die ambulante Versorgung in Alsdorf und Umgebung." }
  ],
  en: [
    { date: "June 2026", tag: "Team", title: "We're hiring", text: "Looking for qualified nursing professionals for Alsdorf — join our team." },
    ...
    { date: "April 2026", tag: "Location", title: "Alsdorf location expanded", text: "More capacity for outpatient care in Alsdorf and the surrounding area." }
  ],
  ar: [
    { date: "يونيو ٢٠٢٦", tag: "الفريق", title: "نبحث عن تعزيزات", text: "نبحث عن أخصائيي تمريض مؤهلين لألسدورف — انضم إلى فريقنا." },
    ...
    { date: "أبريل ٢٠٢٦", tag: "الموقع", title: "توسيع موقع ألسدورف", text: "قدرات أكبر للرعاية المنزلية في ألسدورف والمناطق المحيطة." }
  ],
  tr: [
    { date: "Haziran 2026", tag: "Ekip", title: "Takviye arıyoruz", text: "Alsdorf için nitelikli bakım uzmanları arıyoruz — ekibimize katılın." },
    ...
    { date: "Nisan 2026", tag: "Lokasyon", title: "Alsdorf lokasyonu genişledi", text: "Alsdorf ve çevresinde evde bakım için daha fazla kapasite." }
  ],
  fr: [
    { date: "Juin 2026", tag: "Équipe", title: "Nous recrutons", text: "Nous recherchons des professionnels de soins qualifiés pour Alsdorf — rejoignez notre équipe." },
    ...
    { date: "Avril 2026", tag: "Site", title: "Site de Alsdorf agrandi", text: "Plus de capacités pour les soins à domicile à Alsdorf et ses environs." }
  ],
  ru: [
    { date: "Июнь 2026", tag: "Команда", title: "Мы ищем сотрудников", text: "Ищем квалифицированных специалистов по уходу для Альсдорфа — присоединяйтесь к команде." },
    ...
    { date: "Апрель 2026", tag: "Филиал", title: "Расширен филиал в Альсдорфе", text: "Больше возможностей для амбулаторного ухода в Альсдорфе и окрестностях." }
  ]
};
