...
const I18N = {
  de: {
    "meta.title": "CultureMed — Ambulanter Pflegedienst in Kaarst",
    ...
    "hero.kicker": "Ambulanter Pflegedienst · Kaarst",
    ...
    "hero.card2.t": "1 Standort", "hero.card2.d": "Kaarst",
    ...
    "about.p1": "CultureMed ist Ihr ambulanter Pflegedienst in Kaarst. Wir unterstützen Menschen dabei, in ihrer vertrauten Umgebung zu bleiben — selbstbestimmt, würdevoll und sicher.",
    ...
    "footer.desc": "Ihr ambulanter Pflegedienst in Kaarst, der neue Wege geht.",
  ...
  en: {
    "meta.title": "CultureMed — Outpatient Care Service in Kaarst",
    ...
    "hero.kicker": "Outpatient Care Service · Kaarst",
    ...
    "hero.card2.t": "1 location", "hero.card2.d": "Kaarst",
    ...
    "about.p1": "CultureMed is your outpatient care service in Kaarst. We help people stay in their familiar surroundings — self-determined, dignified and safe.",
    ...
    "footer.desc": "Your outpatient care service in Kaarst, taking new paths.",
  ...
  ar: {
    "meta.title": "كالتشر ميد — خدمة رعاية منزلية في كارست",
    ...
    "hero.kicker": "خدمة رعاية منزلية · كارست",
    ...
    "hero.card2.t": "موقع واحد", "hero.card2.d": "كارست",
    ...
    "about.p1": "كالتشر ميد هي خدمة الرعاية المنزلية الخاصة بك في كارست. نساعد الناس على البقاء في محيطهم المألوف — باستقلالية وكرامة وأمان.",
    ...
    "footer.desc": "خدمة الرعاية المنزلية الخاصة بك في كارست، تسلك طرقاً جديدة.",
  ...
  tr: {
    "meta.title": "CultureMed — Kaarst'ta Evde Bakım Hizmeti",
    ...
    "hero.kicker": "Evde Bakım Hizmeti · Kaarst",
    ...
    "hero.card2.t": "1 lokasyon", "hero.card2.d": "Kaarst",
    ...
    "about.p1": "CultureMed, Kaarst'taki evde bakım hizmetinizdir. İnsanların alışık oldukları ortamda kalmalarına yardımcı oluyoruz — bağımsız, onurlu ve güvenli bir şekilde.",
    ...
    "footer.desc": "Kaarst'taki evde bakım hizmetiniz, yeni yollar açıyor.",
  ...
  fr: {
    "meta.title": "CultureMed — Service de soins à domicile à Kaarst",
    ...
    "hero.kicker": "Service de soins à domicile · Kaarst",
    ...
    "hero.card2.t": "1 site", "hero.card2.d": "Kaarst",
    ...
    "about.p1": "CultureMed est votre service de soins à domicile à Kaarst. Nous aidons les personnes à rester dans leur environnement familier — de façon autonome, digne et sûre.",
    ...
    "footer.desc": "Votre service de soins à domicile à Kaarst, qui ouvre de nouvelles voies.",
  ...
  ru: {
    "meta.title": "CultureMed — Служба амбулаторного ухода в Каарсте",
    ...
    "hero.kicker": "Служба амбулаторного ухода · Каарст",
    ...
    "hero.card2.t": "1 филиал", "hero.card2.d": "Каарст",
    ...
    "about.p1": "CultureMed — ваша служба амбулаторного ухода в Каарсте. Мы помогаем людям оставаться в привычной обстановке — самостоятельно, достойно и безопасно.",
    ...
    "footer.desc": "Ваша служба амбулаторного ухода в Каарсте, идущая новыми путями.",
...
const NEWS_DATA = {
  de: [
    { date: "Juni 2026", tag: "Team", title: "Wir suchen Verstärkung", text: "Examinierte Pflegefachkräfte (m/w/d) für Kaarst gesucht — werden Sie Teil unseres Teams." },
  ...
  en: [
    { date: "June 2026", tag: "Team", title: "We're hiring", text: "Looking for qualified nursing professionals for Kaarst — join our team." },
  ...
  ar: [
    { date: "يونيو ٢٠٢٦", tag: "الفريق", title: "نبحث عن تعزيزات", text: "نبحث عن أخصائيي تمريض مؤهلين لكارست — انضم إلى فريقنا." },
  ...
  tr: [
    { date: "Haziran 2026", tag: "Ekip", title: "Takviye arıyoruz", text: "Kaarst için nitelikli bakım uzmanları arıyoruz — ekibimize katılın." },
  ...
  fr: [
    { date: "Juin 2026", tag: "Équipe", title: "Nous recrutons", text: "Nous recherchons des professionnels de soins qualifiés pour Kaarst — rejoignez notre équipe." },
  ...
  ru: [
    { date: "Июнь 2026", tag: "Команда", title: "Мы ищем сотрудников", text: "Ищем квалифицированных специалистов по уходу для Каарста — присоединяйтесь к команде." },
