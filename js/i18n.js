/* ============================================================
   CuraCare — Mehrsprachiger Content-Layer
...
const I18N = {
  de: {
    ...
    "about.p1": "CuraCare ist Ihr ambulanter Pflegedienst in Viersen und Kaarst. Wir unterstützen Menschen dabei, in ihrer vertrauten Umgebung zu bleiben — selbstbestimmt, würdevoll und sicher.",
    ...
    "leitbild.author": "Das CuraCare Team",
    ...
    "news.kicker": "Aktuelles", "news.title": "Neues von CuraCare",
  ...
  en: {
    ...
    "about.p1": "CuraCare is your outpatient care service in Viersen and Kaarst. We help people stay in their familiar surroundings — self-determined, dignified and safe.",
    ...
    "leitbild.author": "The CuraCare Team",
    ...
    "news.kicker": "News", "news.title": "Latest from CuraCare",
  ...
  ar: {
    "meta.title": "كوراكير — خدمة رعاية منزلية في فيرزن وكارست",
    ...
    "about.p1": "كوراكير هي خدمة الرعاية المنزلية الخاصة بك في فيرزن وكارست. نساعد الناس على البقاء في محيطهم المألوف — باستقلالية وكرامة وأمان.",
    ...
    "news.kicker": "آخر الأخبار", "news.title": "جديد كوراكير",
    ...
    "careers.lead": "في كوراكير لا يهم فقط ما تفعله — بل كيف نتعامل مع بعضنا. شروط عادلة وتقدير حقيقي وفريق متماسك.",
  ...
  tr: {
    "meta.title": "CuraCare — Viersen & Kaarst'ta Evde Bakım Hizmeti",
    ...
    "about.p1": "CuraCare, Viersen ve Kaarst'taki evde bakım hizmetinizdir. İnsanların alışık oldukları ortamda kalmalarına yardımcı oluyoruz — bağımsız, onurlu ve güvenli bir şekilde.",
    ...
    "leitbild.author": "CuraCare Ekibi",
    ...
    "news.kicker": "Güncel", "news.title": "CuraCare'den haberler",
    ...
    "careers.lead": "CuraCare'de yalnızca ne yaptığınız değil — birbirimize nasıl davrandığımız da önemlidir. Adil koşullar, gerçek takdir ve birbirine kenetlenen bir ekip.",
  ...
  fr: {
    "meta.title": "CuraCare — Service de soins à domicile à Viersen & Kaarst",
    ...
    "about.p1": "CuraCare est votre service de soins à domicile à Viersen et Kaarst. Nous aidons les personnes à rester dans leur environnement familier — de façon autonome, digne et sûre.",
    ...
    "leitbild.author": "L'équipe CuraCare",
    ...
    "news.kicker": "Actualités", "news.title": "Les nouvelles de CuraCare",
    ...
    "careers.lead": "Chez CuraCare, ce qui compte n'est pas seulement ce que vous faites — mais la façon dont nous nous traitons. Conditions équitables, reconnaissance réelle et une équipe soudée.",
  ...
  ru: {
    "meta.title": "CuraCare — Служба амбулаторного ухода в Фирзене и Кaaрсте",
    ...
    "about.p1": "CuraCare — ваша служба амбулаторного ухода в Фирзене и Каарсте. Мы помогаем людям оставаться в привычной обстановке — самостоятельно, достойно и безопасно.",
    ...
    "leitbild.author": "Команда CuraCare",
    ...
    "news.kicker": "Новости", "news.title": "Новости CuraCare",
    ...
    "careers.lead": "В CuraCare важно не только то, что вы делаете, но и то, как мы относимся друг к другу. Честные условия, настоящее признание и сплочённая команда.",
